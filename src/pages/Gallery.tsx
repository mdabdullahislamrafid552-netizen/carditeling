  ...
  return (
    <div className="bg-background min-h-screen flex flex-col selection:bg-primary/30 selection:text-primary">
      ...
      <main className="flex-grow pt-32 pb-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
        ...
        {/* Filters */}
        <FadeIn className="flex flex-wrap items-center gap-4 mb-12 border-b border-outline-variant/20 pb-6" delay={0.2}>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          {/* Feature Item 1 */}
          <StaggerItem className="md:col-span-8 md:row-span-2">
            <ClientLink to="/gallery/porsche-911-gt3-rs" className="group relative rounded-lg overflow-hidden border border-outline-variant/10 bg-surface-container-low min-h-[400px] md:min-h-[600px] cursor-pointer block h-full">
          ...
          <StaggerItem className="md:col-span-4">
            <ClientLink to="/gallery/ferrari-f8" className="group relative rounded-lg overflow-hidden border border-outline-variant/10 bg-surface-container-low min-h-[288px] cursor-pointer block h-full">
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: "url('/images/service_interior.jpg')" }}></div>
          ...
          {/* Smaller Item 3 */}
          <StaggerItem className="md:col-span-4">
            <ClientLink to="/gallery/bentley-continental" className="group relative rounded-lg overflow-hidden border border-outline-variant/10 bg-surface-container-low min-h-[288px] cursor-pointer block h-full">
          ...
          <StaggerItem className="md:col-span-6">
            <ClientLink to="/gallery/aston-martin-vantage" className="group relative rounded-lg overflow-hidden border border-outline-variant/10 bg-surface-container-low min-h-[400px] cursor-pointer block h-full">
          ...
          {/* Medium Item 5 */}
          <StaggerItem className="md:col-span-6">
            <ClientLink to="/gallery/mclaren-720s" className="group relative rounded-lg overflow-hidden border border-outline-variant/10 bg-surface-container-low min-h-[400px] cursor-pointer block h-full">
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: "url('/images/service_ppf.jpg')" }}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/10 to-transparent"></div>
              <div className="absolute bottom-0 left-0 p-8">
                <div className="inline-block bg-surface-container/80 backdrop-blur-md px-3 py-1 mb-3 rounded-sm border border-outline-variant/30">
        ...
        <FadeIn className="mt-32 text-center bg-surface/60 backdrop-blur-xl border border-outline-variant/20 rounded-xl p-8 md:p-16 relative overflow-hidden" direction="up">
