          ...
          <ClientLink to="/" className="text-headline-lg font-headline-lg font-bold tracking-tighter text-on-surface flex items-center gap-2">
            {client.branding.logoUrl ? (
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-xl">DeFeo's</span>
                <span className="text-sm font-normal text-primary">Diamond Detailing</span>
      ...
      <footer className="bg-surface-container-lowest border-t border-outline-variant/10 py-16 px-margin-mobile md:px-margin-desktop mt-20 relative overflow-hidden">
        ...
        <div className="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
          <div>
            {client.branding.logoUrl ? (
              ...
              <div className="flex flex-col leading-tight mb-4">
                <span className="text-xl font-bold text-on-surface">DeFeo's</span>
                <span className="text-sm font-normal text-primary">Diamond Detailing</span>
                <span className="text-[10px] text-on-surface-variant font-normal tracking-normal">(Temporary logo)</span>
              </div>
            )}
            <p className="text-on-surface-variant font-body-sm">Mobile auto detailing for interior, exterior, and full detail services across Bergen County, NJ and surrounding areas.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-on-surface-variant">
              <li><ClientLink to="/service-area" className="hover:text-primary">Bergen County, NJ</ClientLink></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-on-surface-variant">
              ...
              <li className="flex items-center gap-2"><span className="font-bold text-primary">@</span> @defeosdiamonddetailing</li>
            </ul>
          </div>
        </div>
