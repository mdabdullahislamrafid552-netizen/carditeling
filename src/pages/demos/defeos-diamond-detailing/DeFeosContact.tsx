      ...
      <div className="max-w-container-max mx-auto">
        <FadeIn className="mb-16 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 border border-outline-variant/30 bg-surface px-4 py-2 w-fit rounded mb-6 mx-auto">
            ...
            <span className="font-label-caps text-label-caps text-on-surface-variant tracking-widest uppercase">Contact DeFeo's Diamond Detailing</span>
          </div>
          ...
          <FadeIn delay={0.1}>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-on-surface">Bergen County, NJ and surrounding areas</p>
                </div>
              </div>
            ...
            <div className="mt-12 p-6 border border-outline-variant/20 bg-surface-container-low rounded text-on-surface-variant">
              <p className="font-body-md italic mb-4">
                "Demo site active. Direct messaging via Instagram or calling is currently the best way to contact the business."
              </p>
            </div>
          </FadeIn>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <select className="w-full bg-background border border-outline-variant/30 rounded px-4 py-3 focus:border-primary focus:outline-none text-on-surface">
                  ...
                  <option value="exterior">Exterior Wash — $60</option>
                  <option value="basic-interior">Basic Interior Cleanse — $60</option>
                  <option value="deep-interior">Deep Interior Cleanse — $85</option>
                  <option value="full">Full Detail — $100</option>
                  <option value="advanced">Advanced Detail — $125</option>
                </select>
              </div>
              
              <div>
                <label className="block text-sm font-label-caps text-on-surface-variant mb-2">Mobile Service Location</label>
                <input type="text" className="w-full bg-background border border-outline-variant/30 rounded px-4 py-3 focus:border-primary focus:outline-none text-on-surface" placeholder="e.g. Home, Office, etc." />
              </div>
