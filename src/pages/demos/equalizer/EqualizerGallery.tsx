      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <FadeIn className="mb-16">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl border-l-2 border-primary/50 pl-6">
            Real client photos will be added later. For now, this demo uses approved master website visuals to show how The Equalizer Mobile Car Detailing’s result and gallery sections will appear.
          </p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <FadeIn key={idx} delay={idx * 0.1}>
              <div className="bg-surface border border-outline-variant/10 rounded overflow-hidden shadow group relative">
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-center items-center z-10 p-4 text-center">
                  ...
                  <span className="text-white/70 text-xs">Client photo to be added later</span>
                </div>
...
export default EqualizerGallery;
